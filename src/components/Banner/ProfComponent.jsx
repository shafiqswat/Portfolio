    ...
    <Container id='home'>
      <Slide direction='left'>
        <Texts>
          ...
          <h1 className='green'>Muhammad Shafiq</h1>
          <h3>Frontend Web Developer</h3>
          <h3>
            🚀Elevate Your Web Experience with a Skilled React Developer!🌐
          </h3>
          <p>
            🎨 Proficient in HTML, CSS, JavaScript, and Bootstrap, I specialize
            in crafting visually appealing and high-performance web
            applications.
          </p>
          <p>
